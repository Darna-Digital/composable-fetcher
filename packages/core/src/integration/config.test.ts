...
describe("integration: header management", () => {
...
describe("integration: observability (onSpan)", () => {
...
describe("integration: configure() for derived instances", () => {
...
describe("integration: global error handling config", () => {
